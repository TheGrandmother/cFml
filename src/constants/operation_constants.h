...
#define DIE_VALUE	0x13ULL
#define RET_VALUE	0x17ULL
#define ADD_VALUE	0x8ULL
#define EQL_VALUE	0xaULL
#define MUL_VALUE	0xbULL
#define DIV_VALUE	0xcULL
#define EFC_VALUE	0x12ULL
#define SOZ_VALUE	0x19ULL
#define NEQ_VALUE	0xdULL
#define AND_VALUE	0x4ULL
#define DEC_VALUE	0x1ULL
#define JMP_VALUE	0x1aULL
#define JOZ_VALUE	0x14ULL
#define HLT_VALUE	0x15ULL
#define MOV_VALUE	0x2ULL
#define SOO_VALUE	0x16ULL
#define LES_VALUE	0x9ULL
#define JSR_VALUE	0x18ULL
#define NOT_VALUE	0x11ULL
#define JOO_VALUE	0x1bULL
